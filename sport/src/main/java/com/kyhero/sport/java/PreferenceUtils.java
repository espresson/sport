...
public class PreferenceUtils {
    ...
    public static boolean getCameraXFrontOrBack(Context context) {

        SharedPreferences sharedPreferences = context.getSharedPreferences("SPORT", Context.MODE_PRIVATE);//PreferenceManager.getDefaultSharedPreferences(context);
        String prefKey = context.getString(R.string.pref_camera_info_frontorback);
        Log.d("TAG", "lensFacing Get facing to " + sharedPreferences.getBoolean(prefKey, false));
        return sharedPreferences.getBoolean(prefKey, false);
    }
    public static void setCameraXFrontOrBack(Context context,boolean isfront) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("SPORT", Context.MODE_PRIVATE);//PreferenceManager.getDefaultSharedPreferences(context);
        String prefKey = context.getString(R.string.pref_camera_info_frontorback);
        sharedPreferences.edit().putBoolean(prefKey, isfront).commit();
    }
