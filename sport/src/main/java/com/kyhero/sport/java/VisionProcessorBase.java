...
import com.kyhero.sport.BitmapUtils;
import com.kyhero.sport.CameraImageGraphic;
import com.kyhero.sport.FrameMetadata;
import com.kyhero.sport.GraphicOverlay;
import com.kyhero.sport.InferenceInfoGraphic;
import com.kyhero.sport.ScopedExecutor;
import com.kyhero.sport.TemperatureMonitor;
...
//        CameraXLivePreviewActivity.bitmapfromImageProxy = bitmap.copy(Bitmap.Config.ARGB_8888, true);
//      }
//
//    }
  ...
  private Task<T> setUpListener(
    ...
    return task.addOnSuccessListener(
            ...
            results -> {
              ...
              if (originalCameraImage != null/* && SportFragment.debugmode*/) {
