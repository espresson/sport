...
package com.kyhero.sport.java.posedetector;
...
import com.kyhero.sport.GraphicOverlay.Graphic;
...
public class PoseGraphic extends Graphic {
    ...
    public void draw(Canvas canvas) {
        ...
        sportListener.situp(nose,
                leftEar, leftShoulder, leftElbow, leftWrist, leftIndex, leftHip, leftKnee, leftAnkle,
                rightEar, rightShoulder, rightElbow, rightWrist, rightIndex, rightHip, rightKnee, rightAnkle);

        sportListener.pullup(nose, leftMouth, rightMouth,leftEye,rightEye,
                leftShoulder, leftElbow, leftIndex,
                rightShoulder, rightElbow, rightIndex,
                leftHip, leftKnee, leftAnkle,
                rightHip, rightKnee, rightAnkle);

        sportListener.pushup(nose,leftShoulder, leftElbow, leftWrist, leftHip, leftKnee, leftAnkle,
                rightShoulder, rightElbow, rightWrist, rightHip, rightKnee, rightAnkle);

        // Draw inFrameLikelihood for all points
        if (false/*showInFrameLikelihood*/) {
            for (PoseLandmark landmark : landmarks) {
                canvas.drawText(String.format(Locale.US, "%.2f", landmark.getInFrameLikelihood()),
                        translateX(landmark.getPosition().x), translateY(landmark.getPosition().y), whitePaint);
            }
        }
    }
